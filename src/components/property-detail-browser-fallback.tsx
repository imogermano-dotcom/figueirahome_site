...
export function PropertyDetailBrowserFallback({ slug, reference }: { slug: string; reference?: string }) {
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    const fields = "imovel_ref,titulo,natureza,disponibilidade,estado,quartos,casas_banho,area_util,area_bruta,area_terreno,venda_preco,arrendamento_preco,concelho,freguesia,zona,descricao,foto_principal,fotos,plantas,video_url,visita_virtual_url";
